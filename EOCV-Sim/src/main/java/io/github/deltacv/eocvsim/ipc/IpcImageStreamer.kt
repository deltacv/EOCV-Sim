...
class IpcImageStreamer(
    ...
    private val buffImgRecycler = BufferedImageRecycler(2, Dimension(
    ...
    fun sendFrame(
        ...
        val buffImg = buffImgRecycler.takeBufferedImage()
        CvUtil.matToBufferedImage(scaledImg, buffImg)
        scaledImg.returnMat()

        server.broadcastBinary(opcode, id, (buffImg.raster.dataBuffer as DataBufferByte).data)

        buffImgRecycler.returnBufferedImage(buffImg)
    }
