...
class PluginManager : PhaseOrchestrableBase(), KoinComponent {
    ...
    companion object {
        val PLUGIN_FOLDER = org.deltacv.eocvsim.plugin.PLUGIN_FOLDER
        val PLUGIN_CACHING_FOLDER = org.deltacv.eocvsim.plugin.PLUGIN_CACHING_FOLDER
        val FILESYSTEMS_FOLDER = org.deltacv.eocvsim.plugin.FILESYSTEMS_FOLDER
    ...
    override suspend fun init() {
        ...
        if (configManager.config.flags.getOrDefault("startFreshPlugins", false)) {
            ...
            configManager.config.flags["startFreshPlugins"] = false
