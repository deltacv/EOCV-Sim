 ...
 * - This list is checked AFTER the whitelist, meaning it OVERRIDES the whitelist.
 *
 * NOTE:
 * This is used to block dangerous sub-packages within a whitelisted parent package.
 *
 * AUTHORITY:
...
val dynamicCodePackageWhitelist = setOf(
    ...
    // API
    "org.deltacv.eocvsim.plugin",
    "org.deltacv.eocvsim.sandbox",

    // Third-party libs explicitly allowed
    "org.deltacv.common.util",
    "net.lingala.zip4j",
    "com.google.jimfs",
    "org.slf4j",
    "com.apache.logging",
