...
public class Matrix {
    ...
    // Helper function to calculate the index in the 1D array representing a 4x4 matrix.
     ...
     */
    // Java implementation of multiplyMM with offsets
    public static void multiplyMM(float[] result, int resultOffset,
        ...
        // Multiply the two 4x4 matrices with the given offsets.
        for (int i = 0; i < 4; i++) {
            final float rhs_i0 = rhs[rhsOffset + I(i, 0)];
            ...
            for (int j = 1; j < 4; j++) {
                final float rhs_ij = rhs[rhsOffset + I(i, j)];
    ...
    private static void mx4transform(float[] lhsMat, int lhsMatOffset,
                                     float[] rhsVec, int rhsVecOffset,
                                     float[] resultVec, int resultVecOffset) {
        resultVec[resultVecOffset + 0] = lhsMat[lhsMatOffset + 0 + 4 * 0] * rhsVec[rhsVecOffset + 0] +
                lhsMat[lhsMatOffset + 0 + 4 * 1] * rhsVec[rhsVecOffset + 1] +
                lhsMat[lhsMatOffset + 0 + 4 * 2] * rhsVec[rhsVecOffset + 2] +
                lhsMat[lhsMatOffset + 0 + 4 * 3] * rhsVec[rhsVecOffset + 3];

        resultVec[resultVecOffset + 1] = lhsMat[lhsMatOffset + 1 + 4 * 0] * rhsVec[rhsVecOffset + 0] +
                lhsMat[lhsMatOffset + 1 + 4 * 1] * rhsVec[rhsVecOffset + 1] +
                lhsMat[lhsMatOffset + 1 + 4 * 2] * rhsVec[rhsVecOffset + 2] +
                lhsMat[lhsMatOffset + 1 + 4 * 3] * rhsVec[rhsVecOffset + 3];

        resultVec[resultVecOffset + 2] = lhsMat[lhsMatOffset + 2 + 4 * 0] * rhsVec[rhsVecOffset + 0] +
                lhsMat[lhsMatOffset + 2 + 4 * 1] * rhsVec[rhsVecOffset + 1] +
                lhsMat[lhsMatOffset + 2 + 4 * 2] * rhsVec[rhsVecOffset + 2] +
                lhsMat[lhsMatOffset + 2 + 4 * 3] * rhsVec[rhsVecOffset + 3];

        resultVec[resultVecOffset + 3] = lhsMat[lhsMatOffset + 3 + 4 * 0] * rhsVec[rhsVecOffset + 0] +
                lhsMat[lhsMatOffset + 3 + 4 * 1] * rhsVec[rhsVecOffset + 1] +
                lhsMat[lhsMatOffset + 3 + 4 * 2] * rhsVec[rhsVecOffset + 2] +
                lhsMat[lhsMatOffset + 3 + 4 * 3] * rhsVec[rhsVecOffset + 3];
    }
    ...
    public static void multiplyMV(float[] resultVec,
                                  ...
                                  float[] rhsVec, int rhsVecOffset) {
        if(resultVec == null) {
            throw new IllegalArgumentException("resultVec must not be null");
        }

        if(lhsMat == null) {
            throw new IllegalArgumentException("lhsMat must not be null");
        }

        if(rhsVec == null) {
            throw new IllegalArgumentException("rhsVec must not be null");
        }
        ...
        mx4transform(lhsMat, lhsMatOffset, rhsVec, rhsVecOffset, resultVec, resultVecOffset);
    }
